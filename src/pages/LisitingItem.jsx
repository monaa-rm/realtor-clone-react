...
const LisitingItem = ({ listing, id , onDelete , onEdit}) => {
  return (
    <li className='bg-white flex  flex-col justify-between items-center relative m-[10px]
     shadow-md rounded-md overflow-hidden transition duration-150 
    hover:shadow-xl 
    '>
      <Link to={`/category/${listing.type}/${id}`} className='contents' >
        <img src={listing.imgUrls[0]} alt="img"
        ...
        <div className='w-full p-[10px] '>
          ...
          <div className='flex justify-between items-center mt-[10px] space-x-3'>
